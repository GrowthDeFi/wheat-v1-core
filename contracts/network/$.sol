...
library $
{
	...
	address constant ibBNB =
		NETWORK == Network.Bscmain ? 0x3bB5f6285c312fc7E1877244103036ebBEda193d :
		// NETWORK == Network.Bsctest ? 0x0000000000000000000000000000000000000000 :
		0x0000000000000000000000000000000000000000;

	// declared after original deploy
	address constant WHEAT =
		NETWORK == Network.Bscmain ? 0x3ab63309F85df5D4c3351ff8EACb87980E05Da4E :
		NETWORK == Network.Bsctest ? 0x8f87B6876D9950a3E8905Fcd18848AE5CDc5BDB9 :
		0x0000000000000000000000000000000000000000;

	address constant WHEAT_EXCHANGE_IMPL =
		NETWORK == Network.Bscmain ? 0x409E7995bBDeb17CDaEB7a5C1C84213846026aB2 :
