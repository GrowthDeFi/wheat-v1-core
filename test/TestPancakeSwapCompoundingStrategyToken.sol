...
contract TestPancakeSwapCompoundingStrategyToken is Env
{
	function test01() external
	{
		...
		PancakeSwapCompoundingStrategyToken(_strategy).deposit(20e18, _minShares, false);
		...
		PancakeSwapCompoundingStrategyToken(_strategy).withdraw(_shares, _minAmount, false);
